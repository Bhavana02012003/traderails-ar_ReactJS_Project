...
const InternationalQuoteReview = ({
  onBack,
}: InternationalQuoteReviewProps) => {
  const [buyerComments, setBuyerComments] = useState("");
  const [selectedAction, setSelectedAction] = useState<
    "accept" | "negotiate" | "decline" | null
  >(null);

  // Mock 
  // quote data with international features
  const quote = {
    id: "Q-01824",
    ...
    payment: {
      ...
      creditTermsDefinition:
        "Payment due within 30 days of invoice date for pre-approved buyers",
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-4 text-sm text-stone-600 mt-1">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span>
                    Seller: {formatLocalTime(quote.seller.timeZone)} | Your
                    time: {formatLocalTime(quote.buyer.timeZone)}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <Card className="bg-white/70 backdrop-blur-sm border-0 shadow-lg">
                ...
                <CardContent>
                  <div className="flex flex-col sm:flex-row items-center justify-between p-4 bg-stone-50 rounded-lg gap-4">
                    {/* Seller Info */}
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto sm:justify-end">
                      <Button
                        variant="outline"
                        size="sm"
                        className="text-emerald-700 border-emerald-200 w-full sm:w-auto"
                      >
                      ...
                      <div>
                        ...
                        <div className="space-y-3 text-sm">
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <span className="text-stone-900 font-medium">
                              {quote.shipping.transitTime}
                            </span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-stone-600">Lead Time:</span>
                            <span className="text-stone-900 font-medium">
                              {quote.shipping.leadTime}
                            </span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-stone-600 flex items-center gap-1">
                              ...
                              <Tooltip>
                                ...
                                <TooltipContent className="max-w-xs">
                                  <p className="text-sm">
                                    {quote.shipping.incotermDefinition}
                                  </p>
                                </TooltipContent>
                              </Tooltip>
                            </span>
                        ...
                        <div className="p-4 bg-amber-50 rounded-lg space-y-3">
                          ...
                          <div className="flex justify-between items-center">
                            <span className="text-stone-700 text-sm flex items-center gap-1">
                              ...
                              <Tooltip>
                                ...
                                <TooltipContent className="max-w-xs">
                                  <p className="text-sm">
                                    {quote.payment.creditTermsDefinition}
                                  </p>
                                </TooltipContent>
                              </Tooltip>
                            </span>
                          ...
                          <div className="pt-2 border-t border-amber-200">
                            <p className="text-xs text-stone-600">
                              *TradeRails financing available - no additional
                              cost to buyer
                            </p>
                          </div>
                        </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-4 bg-blue-50 rounded-lg">
                      ...
                      <p className="text-2xl font-bold text-blue-900">
                        {formatCurrency(
                          quote.totals.localCurrency.total,
                          quote.totals.localCurrency.code
                        )}
                      </p>
                    ...
                    <div className="p-4 bg-stone-50 rounded-lg">
                      ...
                      <p className="text-2xl font-bold text-stone-900">
                        {formatCurrency(
                          quote.totals.sellerCurrency.total,
                          quote.totals.sellerCurrency.code,
                          "en-IN"
                        )}
                      </p>
                      <p className="text-sm text-stone-600 mt-1">
                        Exchange Rate: {quote.totals.sellerCurrency.rate}{" "}
                        INR/USD
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        <p className="text-sm font-medium text-amber-800">
                          FX Protection Available
                        </p>
                        <p className="text-xs text-amber-700 mt-1">
                          Lock in current exchange rate to protect against
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between text-sm">
                      <span className="text-stone-600 flex items-center gap-1">
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p className="text-sm">
                              Cost of shipping from origin to destination port
                            </p>
                          </TooltipContent>
                        </Tooltip>
                      </span>
                    ...
                    <div className="text-xs text-stone-500 space-y-1">
                      ...
                      <p>
                        Rate: 1 USD = {quote.totals.sellerCurrency.rate} INR
                      </p>
                    </div>
                  </div>
